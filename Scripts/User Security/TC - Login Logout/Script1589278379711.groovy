...
WebUI.setText(findTestObject('Object Repository/orangehrm-opensource/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), 'Admin')

WebUI.setEncryptedText(findTestObject('Object Repository/orangehrm-opensource/Page_OrangeHRM/input_Username_txtPassword'), 
    'hUKwJTbofgPU9eVlw/CnDQ==')

WebUI.click(findTestObject('Object Repository/orangehrm-opensource/Page_OrangeHRM/input_Password_Submit'))
